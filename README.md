# 『KOO分期』m.koofenqi.com 项目结构讲解 
        启动 
        首先配置host 127.0.0.1	m.koofenqi.com
        npm i
        sudo npm run dev
        访问地址：http://m.koofenqi.com/pages/模块名称/模块路由BAS/路由地址
        入口地址:http://m.koofenqi.com/pages/adminkoofenqi/
...
## ⑦ 状态管理与视图拆分
[Vuex 源码分析可以看这篇文章](https://github.com/PerseveranceZ/zero-blog/issues/2)。
